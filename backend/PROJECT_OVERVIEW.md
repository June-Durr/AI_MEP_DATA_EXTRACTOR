...
- `backend/lambda/quickAnalysis.js` - Claude Haiku AI analysis
- `frontend/src/components/Camera.js` - Multi-RTU capture
...
- Backend: AWS Lambda (Claude Haiku via Bedrock)
